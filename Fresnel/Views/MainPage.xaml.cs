...
namespace Fresnel.Views
{
    ...
    public partial class MainPage : MasterDetailPage
    {
        ...
        public MainPage()
        {
            ...
            var tripLogPage = new MasterPageItem() { Title = "Test - GPS", Icon = "diamond - bright green.png", TargetType = typeof(TripLogPage) };
            var page7 = new MasterPageItem() { Title = "Test - Hardcoded Collection Data", Icon = "diamond 2.png", TargetType = typeof(Page7) };
            var openIncidentsPage = new MasterPageItem() { Title = "Test - Open Incidents", Icon = "diamond black.png", TargetType = typeof(OpenIncidentsPage) };
